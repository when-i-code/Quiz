...
class QuizBee extends Component {
    ...
    playAgain = () => {
      this.getQuestions();
      this.setState({score: 0, responses: 0, display: 'block'});
    ...
    render() {
        return (
            <div className='container'>
                <div style={{display: this.state.display}} className='title'>Answer the following questions: </div>
                ...
                {this.state.responses === 5 ? <Result score={this.state.score} playAgain={this.playAgain} hideDiv={this.hideDiv} /> : null}
            </div>
        );
    }
}
